...
from accounts.views import home, login_view, register, user_profile, logout_page, post_view, edit_profile, following, post_delete
...
urlpatterns = [
    ...
    path('profiles/<str:username>/<int:idx>/delete', post_delete, name='delete'),
]
